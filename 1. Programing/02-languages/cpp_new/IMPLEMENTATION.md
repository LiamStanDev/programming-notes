...
| **08-常用庫與工具鏈.md** (8 章)        | 09-第三方庫/ (7 篇)                 | 主題整合          | ✅ 完整 |
| - Boost (排除 Asio)                    | 01-Boost 庫精選.md                  | cpp/07/03         | ⭐⭐    |
| - JSON/FlatBuffers/Protobuf            | 02-序列化庫.md                      | 融合 cpp/07/05    | ⭐⭐⭐  |
| - Folly                                | 03-Folly 核心組件.md                | 新增              | ⭐⭐⭐  |
| - Abseil                               | 04-Abseil 核心組件.md               | 新增              | ⭐⭐⭐  |
| - ZeroMQ                               | 05-網路庫_ZeroMQ.md                 | 保留              | ⭐⭐    |
| - spdlog                               | 06-日誌庫_spdlog.md                 | 完整採用          | ⭐⭐⭐  |
| - GTest/Benchmark                      | 07-測試框架.md                      | 融合 cpp/06/05    | ⭐⭐    |
...
gantt
    ...
    section 高階技術  
    批次3 併發與並行      :done, batch3, 2025-11-27, 1d
    批次4 高性能編程      :done, batch4, after batch3, 2d
    批次5 異步編程        :active, batch5, after batch4, 3d
    section 系統層面
