...
> 本章涵蓋 C++ 網路編程基礎與進階技術，包括 TCP/UDP Socket API、I/O 多路復用基礎、零拷貝技術等。
> 
> ⚠️ **重要提示**: 本章專注於**同步網路編程與 Socket 基礎**。**異步編程**相關內容（Reactor/Proactor 模式、io_uring 深度、Boost.Asio、協程、資料庫異步交互等）已移至 **[09-異步編程專題](09-異步編程專題.md)**，請參閱該專題獲取完整的異步編程知識。
