...
#### 解決虛擬機沒有網路問題
因爲 libvirt 默認使用 nftables 來設定 NAT，但是他默認的設定有問題，我們可以透過 iptables-nft 兼容曾使用 iptables 命令操作 nftables，所以讓 libvirt 使用 iptables 來進行操作。
ref: https://bbs.archlinux.org/viewtopic.php?id=284664
...
<domain type="kvm">
  <name>win10</name>
  <uuid>fcb1ab7f-3d7a-4b19-b15a-009bc0319329</uuid>
  <metadata>
